...
* [Maven](./kotest-maven) &mdash; example of a project using Apache Maven with Kotest rather than Gradle.
* [Amper](./kotest-amper) &mdash; example of a project using Amper with Kotest rather than Gradle.
